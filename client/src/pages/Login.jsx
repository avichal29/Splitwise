...
import { Wallet, Mail, Lock, ArrowRight, Sparkles, Sun, Moon, Eye, EyeOff } from 'lucide-react';
      ...
      <div className="max-w-md w-full animate-slide-up">
        ...
        <div className="text-center mb-8">
          ...
          <p className="text-gray-500 dark:text-gray-400 mt-2 flex items-center justify-center gap-1.5">
            ...
            Sign in to split expenses with your squad
          </p>
        </div>
        ...
        <div className="card-glass p-8">
          ...
          <div className="flex items-center gap-3 my-6">
            ...
            <span className="text-xs font-medium text-gray-400 dark:text-surface-400 uppercase tracking-wider">new here?</span>
            <div className="flex-1 h-px bg-gray-200 dark:bg-surface-600"></div>
          </div>
